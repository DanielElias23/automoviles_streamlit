...
st.markdown('''
<span class="badge badge-success">1. Artificial Neural Network (ANN) - Regresión</span>
<span class="badge badge-success">2. Artificial Neural Network (ANN) - Clasificación</span>
''', unsafe_allow_html=True)
